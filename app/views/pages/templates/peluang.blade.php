  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-4">
            {{ HTML::image( 'img/logo_gnt_indonesia.png', 'logo-small', array( 'class' => 'img-responsive' ) ) }} 
            <br/>
            {{ HTML::image( 'img/logo.png', 'logo-small', array( 'class' => 'img-responsive' ) ) }} 
          </div>
          <div class="col-md-8">
            <ul>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        ...
        {{ HTML::image( 'img/emails-publishing-system.png', 'logo-small', array( 'class' => 'img-responsive' ) ) }} 
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div id="article-title" class="col-sm-12">
        Beberapa Artikel Menarik Untuk Anda
      </div>
    </div>
    <div class="row">
