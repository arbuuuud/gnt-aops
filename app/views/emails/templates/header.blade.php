...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>@if(isset($emailtemplate->content_main_title)) {{$emailtemplate->subject}} @endif</title>
		<style type="text/css">
			/* RESET STYLES */
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<!-- CONTENT // -->
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						If you can't see this message, <a href="{{url('showemail/'.$emailtemplate->id)}}" target="_blank" style="text-decoration:none;border-bottom:1px solid #828282;color:#828282;"><span style="color:#828282;">view&nbsp;it&nbsp;in&nbsp;your&nbsp;browser</span></a>.
																					</div>
																				</td>
																			</tr>
																		</table>
