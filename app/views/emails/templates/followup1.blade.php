																...
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			...
																			<div>If you do not want to recieve emails from us, you can <a href="{{url('/unsubscribe/'.$contact->encryptContact())}}" style="text-decoration:none;color:#828282;"><span style="color:#828282;">unsubsribe</span></a>.</div>
																		</div>
																		@endif
																	</td>
																</tr>
